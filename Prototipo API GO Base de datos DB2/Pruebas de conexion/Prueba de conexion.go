...
func main() {
	...
	r.POST("/createCalifir", func(c *gin.Context) {
		start := time.Now()
	...
	r.POST("/createCalifirnew", func(c *gin.Context) {
		start := time.Now()
	...
	r.GET("/califirnew", func(c *gin.Context) {
	...
	r.POST("/update_calfir", func(c *gin.Context) {
		var req struct {
